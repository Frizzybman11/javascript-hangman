...
const wordLibrary = ['beach', 'shade', 'shorts', 'sunny', 'heatwave', 'humidity', 'sunshine', 'sundress', 'sunglasses', 'swimsuit', 'barbecue', 'bonfire', 'sandcastle', 'sunscreen', 'surfing', 'swimming', 'snorkeling', 'fireworks', 'midsummer', 'outdoors', 'august', 'campfire', 'vacation', 'baseball', 'popsicle', 'recreation', 'thunderstorm', 'watermelon', 'waterpark', 'solstice', 'rainbow', 'backyard', 'cookout', 'lifeguard', 'picnic', 'skateboard', 'skating', 'trampoline', 'volleyball', 'lemonade', 'hamburger', 'towel', 'sweat', 'suntan', 'waves', 'sandals', 'goggles', 'surfboard', 'sprinkler', 'cycling', 'camping', 'cottage', 'garden', 'lawnmower', 'nature', 'tourism', 'travel', 'wasps', 'warmth', 'beachball', 'boardwalk', 'butterfly', 'fireflies', 'grasshopper', 'marshmallow', 'trail', 'waterslide', 'pollen', 'flower', 'umbrella', 'birdwatching', 'rabbit', 'squirrel', 'graduation', 'blossom', 'regrowth', 'renewal', 'april', 'breeze', 'puddle', 'bright', 'clear', 'drizzle', 'fertilizer', 'field', 'insects', 'ladybug', 'meadow', 'orchard', 'petals', 'sapling', 'vibrant', 'bumblebee', 'caterpillar', 'colorful']
